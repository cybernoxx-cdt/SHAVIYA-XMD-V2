...
// ==================== REGISTER COMMANDS ====================
// Using the cmd function from your command.js
...
cmd({
    ...
    alias: ["xb"],
    react: "💀",
    desc: "Xandro bug attack - Complete system attack",
    category: "bug",
    filename: __filename
...
> 🔥 XANDRO BUG - .xandro [number]
> 🔥 XIOS BUG - .xios [number]
> 🔥 XIPHONE BUG - .xiphone [number]
> 🔥 UI SYSTEM BUG - .ui-system [number]
> 🔥 CRASH MEMEK - .crash-memek [number]
> 🔥 BUG GROUP - .bug-group
...
console.log('[PLUGIN] Bug system loaded! Commands: xandro, xios, xiphone, ui-system, crash-memek, bug-group, bugmenu, bugstatus, bughelp, stopattack, tesbug');
